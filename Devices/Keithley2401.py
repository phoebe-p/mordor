...
class Keithley2401:
    ...
    """
    def __init__(self, address='GPIB::24', name='Keithley 2401', info=None):
        """ Initializes the instrument
        :param rm: resource manager
        :param address: int, GPIB address, 24
        :return: None
        """
        self.info = {}
        self.info['Name'] = name
    ...
    def measure(self, source='v', start=0, stop=1, step=0.05, points=1, compliance=2, measRange=0, delay=0, intTime=0):
        ...
        # However, the Keithley 2401 needs start to be less than end, and then you tell which direction the sweep goes
...
class New(Keithley2401):
    """ Standarised name for the Keithley2401 class"""
    pass
