...
import tools
from Experiments import Spectroscopy, IV, Temperature, Flash, CV, Photoreflectance, EQE
...
class Splash:
    ...
    def __init__(self):
        ...
        ttk.Button(control_frame, text='EQE', command=self.eqe, style="Splash.TButton").grid(
    ...
    #     """
    #     self.hide()
    #     self.runing.append(Mordor(self, Reflectivity, self.devman, self.experiments))
    #     self.experiments = self.experiments + 1
    ...
    def eqe(self):
        ...
        """
        self.hide()
        self.runing.append(Mordor(self, EQE, self.devman, self.experiments))
        self.experiments = self.experiments + 1
